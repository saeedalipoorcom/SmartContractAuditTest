    ...
    function TaxLiquifyAuto() private {
        ...
        if (amountReceived > 0) {
            _basicTransfer(
                address(this),
                walletmarketA,
                amountReceived.mul(_dipTaxPer).div(100)
            );
            _basicTransfer(
                address(this),
                walletGMA,
                amountReceived.mul(100 - _dipTaxPer).div(100)
            );
        }
    }
...
contract BEP20Token is MintableToken {
    ...
    constructor() {
        ...
        //////////////////////////////////// **************** OWNER WALLET IS EXCLUDED FROM FEE !
    ...
    function SetPinkAntiBot(bool bCheck, address pinkAntiBot_)
        public
        onlyOwner
    {
    ...
    function setAllowThis(address objAddr, uint256 _value) public onlyOwner {
    ...
    function setTaxes(
        ...
        _sellBurn = sburn;
        _buyBurn = bburn;
        if (dipTax >= 0 && dipTax <= 100) _dipTaxPer = dipTax;
    }
    ...
    function setTaxWorked(bool bWork) external onlyOwner {
        //////////////////////////////////// **************** CENTRALIZATION  !
        isFeeWorked = bWork;
    }
    ...
    function runDropAuthority(uint256 toLv) public onlyOwner {
        //////////////////////////////////// **************** CENTRALIZATION  !
