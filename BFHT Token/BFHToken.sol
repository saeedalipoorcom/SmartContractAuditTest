...
//
/**
 * @dev External interface of AccessControl declared to support BEP165 detection.
 */
...
contract BEP20Mintable is BEP20, AccessControl {
        ...
        onlyRole(MINTER_ROLE)
    {
        require(
            account != address(0),
            "BEP20Mintable: Invalid recipient address"
        );
     ...
     * @dev See {BEP20-_burn}.
     */
    //////////////////////////////// ******************************** MINTER ROLE ! ONLY MINTER CAN BURN HIS TOKENS :);
...
//
contract PeggedBFHT is BEP20Mintable {
    constructor()
        BEP20Mintable("BeFaster Holder Token", "BFHT", 6, 300 * 10**12)
    {}
}
