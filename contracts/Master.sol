...
contract Master is Ownable {
    ...
    address payable MasterDAOAddress;
    ...
    function setMasterDAOAddress(address _MasterDAOAddress)
        external
        onlyOwner
        returns (bool)
    {
        MasterDAOAddress = payable(_MasterDAOAddress);
        return true;
    }
    ...
    function _finishCurrentAuction() private {
        ...
        MasterDAOAddress.transfer(address(this).balance);
    }
