 ...
 * allowances. See {IERC20-approve}.
 */
contract DGM is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "DeGEM";
    string private _symbol = "DGM";
    uint8 private _decimals = 18;
    uint256 private _supply = 80085;
    uint256 public taxForLiquidity = 1;
    uint256 public taxForMarketing = 2;
    uint256 public maxTxAmount = 800 * 10**_decimals;
    uint256 public maxWalletAmount = 800 * 10**_decimals;
    address public marketingWallet = 0x93602BCE58A1dd2AeBe30c0F0d840d1bC2443612;
