...
/**
 *This is Smart contract for SMARTY PAY Token NEW VERSION
 * SPY is the third generation of CRYPTO Gateway, which is a unique
 * token for merging FIAT Gateway and Crypto Gateway with real
 * projects, B2B, B2C, payment gateways, POS
 * CREATE BY SMARTY PAY APP
 */
