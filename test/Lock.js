...
describe('Lock', function () {
  ...
  describe('Check functions for transfer token between users', () => {
    ...
    it('Test transferFrom contract', async () => {
      ...
      // lest check something :) address 3 can't  transfer from . because of require msg.sender balance and allowance!
      // in your contract this function can revert because of bug !
